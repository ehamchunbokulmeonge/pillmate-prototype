...
현대 사회는 고령화, 만성질환 증가, 의약품 접근성 확대 등으로 인해 **다제약물 복용자(5개 이상 약물)**가 빠르게 증가하고 있습니다. 약의 종류가 많아질수록 중복 복용, 부작용, 복용 시간 오류 등 약물 오남용 위험은 더욱 커지고 있습니다.

실제 서울시약사회 조사에서도 약사 상담 경험자 중 약 45%가 진통제·위장약 등의 중복 복용 또는 복용 오류를 겪은 것으로 확인되었습니다. 하지만 약사 인력 부족과 상담 시간 문제 등으로 모든 시민에게 충분한 약물 관리를 제공하기 어려운 현실적 한계가 존재합니다.

이에 따라 PillMate 팀은 AI 기술을 활용하여 개인이 스스로 안전하게 약물 복용을 관리할 수 있는 방법을 고민하게 되었고, 그 결과 AI 비전 인식과 약학 데이터 분석을 결합한 ‘PillMate’ 서비스를 기획했습니다.

PillMate는 약을 사진만 찍어도 자동으로 정보를 식별하고, 중복 성분·부작용 가능성을 즉시 분석하여 안전한 복약 환경을 제공합니다.

📊 약사 상담 후 시민 만족도 및 참여 의향
<img width="70%" src="/mnt/data/66da1061-55f5-4b24-9639-d14b3edd7bb6.png"/>

----

🟦 약물 복용 오류 유형
<img width="70%" src="/mnt/data/90a9dbfa-0ead-461d-8154-3bbc300efbc4.png"/>

출처: 서울시약사회, 건강서울페스티벌 다제약물 관리사업 설문(2025년 10월)
